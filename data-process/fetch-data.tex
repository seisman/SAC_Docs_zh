...
SEED即Standard for the Exchange of Seismic Data，其可以存储多台站多分量%这个英文名缩写是SESD，不是SEED，怎么回事？
...
浪费网络资源及硬盘容量。
%RESP文件=台站元信息，SAC格式的波形数据=连续波形数据，如果是这样，我建议在此处统一用词，因为要看这一部分的是最开始的初学者，如果变换术语可能会造成困扰
